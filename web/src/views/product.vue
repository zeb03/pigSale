<template>
    <div class="product-details-container">
        ...
        <el-row :gutter="20">
            <el-col :xs="24" :sm="12">
                <img :src="require(`@/assets${product.image}`)" alt="" class="product-image"/>
            </el-col>
            <el-col :xs="24" :sm="12">
                ...
                <el-button type="primary" round icon="el-icon-shopping-cart" size="medium" class="add-to-cart-button"
                           @click="addCart()">
                    加入购物车
                </el-button>
            </el-col>
        ...
        <div v-if="reviews.length > 0" class="product-reviews-list">
            <div v-for="review in reviews" :key="review.id" class="product-review">
                ...
                <div class="product-review-left">
                    ...
                    <img :src="require(`@/assets/avatar1.png`)" alt="" class="product-review-avatar"/>
                </div>
                <div class="product-review-right">
                    ...
                    <el-col :xs="36" :sm="36">
                        <img :src="require(`@/assets${review.image}`)" alt="" class="review-image"/>
                    </el-col>
...
<script>
    export default {
        ...
        methods: {
            showProduct(){
                this.$axios.get("/product/" + "7").then(res => {
                    console.log(res)
                    this.product = res.data
                })
            },
            showReview(){
                this.$axios.get("/review/page",{
                    params: {
            ...
            addCart() {
                ...
                this.$axios.post("/cart/edit", this.cart).then(res => {
                        console.log(res)
                        if (res.code === 200) {
                            this.$message({
                                message: "加入购物车成功",
